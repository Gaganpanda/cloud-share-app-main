          ...
          {plans.map((plan) => (
            <div
              ...
              {processingPayment ? (
                <button
                  disabled
                  className="w-full py-2 rounded-md font-medium bg-purple-500 text-white flex items-center justify-center gap-2">
                ...
                <PayPalButtons
                  ...
                  onApprove={(data, actions) =>
                    handleApprove(data, actions, plan)
                  }
                  onError={() => {
                    setMessage("Payment failed. Please try again.");
                    setMessageType("error");
